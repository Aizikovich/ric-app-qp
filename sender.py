...
def generate_random_json():
    ...
    c1_B2 = {
        ...
        "x": 0.2,
        "y": 0.2,
        "availPrbDl": random.uniform(1, 100),
        "availPrbUl": random.uniform(1, 100),
        "measPeriodPrb": random.uniform(1, 100),
        "pdcpBytesUl": random.uniform(1, 100),
        "pdcpBytesDl": random.uniform(1, 100),
        "measPeriodPdcpBytes": random.uniform(1, 100),
    }
    c1_B13 = {
        "du-id": 1001,
        "measTimeStampRf": f"{datetime.datetime.now()}",
